...
pub const ISteamClient = struct {
    ...
    pub const ReleaseUser = t.getImplFn("ISteamClient", "ReleaseUser", fn(t.HSteamPipe, t.HSteamUser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hSteamPipe: t.HSteamPipe, hUser: t.HSteamUser) callconv(.C) anyopaque {
    ...
    pub const SetLocalIPBinding = t.getImplFn("ISteamClient", "SetLocalIPBinding", fn([*c]const t.SteamIPAddress_t, t.uint16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unIP: [*c]const t.SteamIPAddress_t, usPort: t.uint16) callconv(.C) anyopaque {
    ...
    pub const SetWarningMessageHook = t.getImplFn("ISteamClient", "SetWarningMessageHook", fn(t.SteamAPIWarningMessageHook_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pFunction: t.SteamAPIWarningMessageHook_t) callconv(.C) anyopaque {
...
pub const ISteamUser = struct {
    ...
    pub const TerminateGameConnection_DEPRECATED = t.getImplFn("ISteamUser", "TerminateGameConnection_DEPRECATED", fn(t.uint32, t.uint16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unIPServer: t.uint32, usPortServer: t.uint16) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamUser_TerminateGameConnection_DEPRECATED:\n\t- unIPServer = {any}\n\t- usPortServer = {any}\n\n", .{ unIPServer, usPortServer });
            return undefined;
        }
    }).noImpl;
    pub const TrackAppUsageEvent = t.getImplFn("ISteamUser", "TrackAppUsageEvent", fn(t.CGameID, i32, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(gameID: t.CGameID, eAppUsageEvent: i32, pchExtraInfo: [*c]const u8) callconv(.C) anyopaque {
    ...
    pub const StartVoiceRecording = t.getImplFn("ISteamUser", "StartVoiceRecording", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamUser_StartVoiceRecording\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const StopVoiceRecording = t.getImplFn("ISteamUser", "StopVoiceRecording", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const EndAuthSession = t.getImplFn("ISteamUser", "EndAuthSession", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamID: t.CSteamID) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamUser_EndAuthSession:\n\t- steamID = {any}\n\n", .{ steamID });
            return undefined;
        }
    }).noImpl;
    pub const CancelAuthTicket = t.getImplFn("ISteamUser", "CancelAuthTicket", fn(t.HAuthTicket) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hAuthTicket: t.HAuthTicket) callconv(.C) anyopaque {
    ...
    pub const AdvertiseGame = t.getImplFn("ISteamUser", "AdvertiseGame", fn(t.CSteamID, t.uint32, t.uint16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDGameServer: t.CSteamID, unIPServer: t.uint32, usPortServer: t.uint16) callconv(.C) anyopaque {
...
pub const ISteamFriends = struct {
    ...
    pub const GetFriendsGroupMembersList = t.getImplFn("ISteamFriends", "GetFriendsGroupMembersList", fn(t.FriendsGroupID_t, [*c]t.CSteamID, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(friendsGroupID: t.FriendsGroupID_t, pOutSteamIDMembers: [*c]t.CSteamID, nMembersCount: i32) callconv(.C) anyopaque {
    ...
    pub const SetInGameVoiceSpeaking = t.getImplFn("ISteamFriends", "SetInGameVoiceSpeaking", fn(t.CSteamID, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDUser: t.CSteamID, bSpeaking: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamFriends_SetInGameVoiceSpeaking:\n\t- steamIDUser = {any}\n\t- bSpeaking = {any}\n\n", .{ steamIDUser, bSpeaking });
            return undefined;
        }
    }).noImpl;
    pub const ActivateGameOverlay = t.getImplFn("ISteamFriends", "ActivateGameOverlay", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchDialog: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamFriends_ActivateGameOverlay:\n\t- pchDialog = {any}\n\n", .{ pchDialog });
            return undefined;
        }
    }).noImpl;
    pub const ActivateGameOverlayToUser = t.getImplFn("ISteamFriends", "ActivateGameOverlayToUser", fn([*c]const u8, t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchDialog: [*c]const u8, steamID: t.CSteamID) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamFriends_ActivateGameOverlayToUser:\n\t- pchDialog = {any}\n\t- steamID = {any}\n\n", .{ pchDialog, steamID });
            return undefined;
        }
    }).noImpl;
    pub const ActivateGameOverlayToWebPage = t.getImplFn("ISteamFriends", "ActivateGameOverlayToWebPage", fn([*c]const u8, t.EActivateGameOverlayToWebPageMode) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchURL: [*c]const u8, eMode: t.EActivateGameOverlayToWebPageMode) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage:\n\t- pchURL = {any}\n\t- eMode = {any}\n\n", .{ pchURL, eMode });
            return undefined;
        }
    }).noImpl;
    pub const ActivateGameOverlayToStore = t.getImplFn("ISteamFriends", "ActivateGameOverlayToStore", fn(t.AppId_t, t.EOverlayToStoreFlag) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nAppID: t.AppId_t, eFlag: t.EOverlayToStoreFlag) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamFriends_ActivateGameOverlayToStore:\n\t- nAppID = {any}\n\t- eFlag = {any}\n\n", .{ nAppID, eFlag });
            return undefined;
        }
    }).noImpl;
    pub const SetPlayedWith = t.getImplFn("ISteamFriends", "SetPlayedWith", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDUserPlayedWith: t.CSteamID) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamFriends_SetPlayedWith:\n\t- steamIDUserPlayedWith = {any}\n\n", .{ steamIDUserPlayedWith });
            return undefined;
        }
    }).noImpl;
    pub const ActivateGameOverlayInviteDialog = t.getImplFn("ISteamFriends", "ActivateGameOverlayInviteDialog", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDLobby: t.CSteamID) callconv(.C) anyopaque {
    ...
    pub const ClearRichPresence = t.getImplFn("ISteamFriends", "ClearRichPresence", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const RequestFriendRichPresence = t.getImplFn("ISteamFriends", "RequestFriendRichPresence", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDFriend: t.CSteamID) callconv(.C) anyopaque {
    ...
    pub const ActivateGameOverlayRemotePlayTogetherInviteDialog = t.getImplFn("ISteamFriends", "ActivateGameOverlayRemotePlayTogetherInviteDialog", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDLobby: t.CSteamID) callconv(.C) anyopaque {
    ...
    pub const ActivateGameOverlayInviteDialogConnectString = t.getImplFn("ISteamFriends", "ActivateGameOverlayInviteDialogConnectString", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchConnectString: [*c]const u8) callconv(.C) anyopaque {
...
pub const ISteamUtils = struct {
    ...
    pub const SetOverlayNotificationPosition = t.getImplFn("ISteamUtils", "SetOverlayNotificationPosition", fn(t.ENotificationPosition) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(eNotificationPosition: t.ENotificationPosition) callconv(.C) anyopaque {
    ...
    pub const SetWarningMessageHook = t.getImplFn("ISteamUtils", "SetWarningMessageHook", fn(t.SteamAPIWarningMessageHook_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pFunction: t.SteamAPIWarningMessageHook_t) callconv(.C) anyopaque {
    ...
    pub const SetOverlayNotificationInset = t.getImplFn("ISteamUtils", "SetOverlayNotificationInset", fn(i32, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nHorizontalInset: i32, nVerticalInset: i32) callconv(.C) anyopaque {
    ...
    pub const StartVRDashboard = t.getImplFn("ISteamUtils", "StartVRDashboard", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const SetVRHeadsetStreamingEnabled = t.getImplFn("ISteamUtils", "SetVRHeadsetStreamingEnabled", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bEnabled: bool) callconv(.C) anyopaque {
    ...
    pub const SetGameLauncherMode = t.getImplFn("ISteamUtils", "SetGameLauncherMode", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bLauncherMode: bool) callconv(.C) anyopaque {
...
pub const ISteamMatchmaking = struct {
    ...
    pub const AddRequestLobbyListStringFilter = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListStringFilter", fn([*c]const u8, [*c]const u8, t.ELobbyComparison) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchKeyToMatch: [*c]const u8, pchValueToMatch: [*c]const u8, eComparisonType: t.ELobbyComparison) callconv(.C) anyopaque {
    ...
    pub const AddRequestLobbyListNumericalFilter = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListNumericalFilter", fn([*c]const u8, i32, t.ELobbyComparison) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchKeyToMatch: [*c]const u8, nValueToMatch: i32, eComparisonType: t.ELobbyComparison) callconv(.C) anyopaque {
    ...
    pub const AddRequestLobbyListNearValueFilter = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListNearValueFilter", fn([*c]const u8, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchKeyToMatch: [*c]const u8, nValueToBeCloseTo: i32) callconv(.C) anyopaque {
    ...
    pub const AddRequestLobbyListFilterSlotsAvailable = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListFilterSlotsAvailable", fn(i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nSlotsAvailable: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable:\n\t- nSlotsAvailable = {any}\n\n", .{ nSlotsAvailable });
            return undefined;
        }
    }).noImpl;
    pub const AddRequestLobbyListDistanceFilter = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListDistanceFilter", fn(t.ELobbyDistanceFilter) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(eLobbyDistanceFilter: t.ELobbyDistanceFilter) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter:\n\t- eLobbyDistanceFilter = {any}\n\n", .{ eLobbyDistanceFilter });
            return undefined;
        }
    }).noImpl;
    pub const AddRequestLobbyListResultCountFilter = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListResultCountFilter", fn(i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(cMaxResults: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter:\n\t- cMaxResults = {any}\n\n", .{ cMaxResults });
            return undefined;
        }
    }).noImpl;
    pub const AddRequestLobbyListCompatibleMembersFilter = t.getImplFn("ISteamMatchmaking", "AddRequestLobbyListCompatibleMembersFilter", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDLobby: t.CSteamID) callconv(.C) anyopaque {
    ...
    pub const LeaveLobby = t.getImplFn("ISteamMatchmaking", "LeaveLobby", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDLobby: t.CSteamID) callconv(.C) anyopaque {
    ...
    pub const SetLobbyMemberData = t.getImplFn("ISteamMatchmaking", "SetLobbyMemberData", fn(t.CSteamID, [*c]const u8, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDLobby: t.CSteamID, pchKey: [*c]const u8, pchValue: [*c]const u8) callconv(.C) anyopaque {
    ...
    pub const SetLobbyGameServer = t.getImplFn("ISteamMatchmaking", "SetLobbyGameServer", fn(t.CSteamID, t.uint32, t.uint16, t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDLobby: t.CSteamID, unGameServerIP: t.uint32, unGameServerPort: t.uint16, steamIDGameServer: t.CSteamID) callconv(.C) anyopaque {
...
pub const ISteamMatchmakingServerListResponse = struct {
    pub const ServerResponded = t.getImplFn("ISteamMatchmakingServerListResponse", "ServerResponded", fn(t.HServerListRequest, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hRequest: t.HServerListRequest, iServer: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingServerListResponse_ServerResponded:\n\t- hRequest = {any}\n\t- iServer = {any}\n\n", .{ hRequest, iServer });
            return undefined;
        }
    }).noImpl;
    pub const ServerFailedToRespond = t.getImplFn("ISteamMatchmakingServerListResponse", "ServerFailedToRespond", fn(t.HServerListRequest, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hRequest: t.HServerListRequest, iServer: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingServerListResponse_ServerFailedToRespond:\n\t- hRequest = {any}\n\t- iServer = {any}\n\n", .{ hRequest, iServer });
            return undefined;
        }
    }).noImpl;
    pub const RefreshComplete = t.getImplFn("ISteamMatchmakingServerListResponse", "RefreshComplete", fn(t.HServerListRequest, t.EMatchMakingServerResponse) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hRequest: t.HServerListRequest, response: t.EMatchMakingServerResponse) callconv(.C) anyopaque {
...
pub const ISteamMatchmakingPingResponse = struct {
    pub const ServerResponded = t.getImplFn("ISteamMatchmakingPingResponse", "ServerResponded", fn([*c]t.gameserveritem_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(server: [*c]t.gameserveritem_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingPingResponse_ServerResponded:\n\t- server = {any}\n\n", .{ server });
            return undefined;
        }
    }).noImpl;
    pub const ServerFailedToRespond = t.getImplFn("ISteamMatchmakingPingResponse", "ServerFailedToRespond", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
...
pub const ISteamMatchmakingPlayersResponse = struct {
    pub const AddPlayerToList = t.getImplFn("ISteamMatchmakingPlayersResponse", "AddPlayerToList", fn([*c]const u8, i32, f32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchName: [*c]const u8, nScore: i32, flTimePlayed: f32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList:\n\t- pchName = {any}\n\t- nScore = {any}\n\t- flTimePlayed = {any}\n\n", .{ pchName, nScore, flTimePlayed });
            return undefined;
        }
    }).noImpl;
    pub const PlayersFailedToRespond = t.getImplFn("ISteamMatchmakingPlayersResponse", "PlayersFailedToRespond", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const PlayersRefreshComplete = t.getImplFn("ISteamMatchmakingPlayersResponse", "PlayersRefreshComplete", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
...
pub const ISteamMatchmakingRulesResponse = struct {
    pub const RulesResponded = t.getImplFn("ISteamMatchmakingRulesResponse", "RulesResponded", fn([*c]const u8, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchRule: [*c]const u8, pchValue: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded:\n\t- pchRule = {any}\n\t- pchValue = {any}\n\n", .{ pchRule, pchValue });
            return undefined;
        }
    }).noImpl;
    pub const RulesFailedToRespond = t.getImplFn("ISteamMatchmakingRulesResponse", "RulesFailedToRespond", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const RulesRefreshComplete = t.getImplFn("ISteamMatchmakingRulesResponse", "RulesRefreshComplete", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
...
pub const ISteamMatchmakingServers = struct {
    ...
    pub const ReleaseRequest = t.getImplFn("ISteamMatchmakingServers", "ReleaseRequest", fn(t.HServerListRequest) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hServerListRequest: t.HServerListRequest) callconv(.C) anyopaque {
    ...
    pub const CancelQuery = t.getImplFn("ISteamMatchmakingServers", "CancelQuery", fn(t.HServerListRequest) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hRequest: t.HServerListRequest) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMatchmakingServers_CancelQuery:\n\t- hRequest = {any}\n\n", .{ hRequest });
            return undefined;
        }
    }).noImpl;
    pub const RefreshQuery = t.getImplFn("ISteamMatchmakingServers", "RefreshQuery", fn(t.HServerListRequest) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hRequest: t.HServerListRequest) callconv(.C) anyopaque {
    ...
    pub const RefreshServer = t.getImplFn("ISteamMatchmakingServers", "RefreshServer", fn(t.HServerListRequest, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hRequest: t.HServerListRequest, iServer: i32) callconv(.C) anyopaque {
    ...
    pub const CancelServerQuery = t.getImplFn("ISteamMatchmakingServers", "CancelServerQuery", fn(t.HServerQuery) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hServerQuery: t.HServerQuery) callconv(.C) anyopaque {
...
pub const ISteamParties = struct {
    ...
    pub const OnReservationCompleted = t.getImplFn("ISteamParties", "OnReservationCompleted", fn(t.PartyBeaconID_t, t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(ulBeacon: t.PartyBeaconID_t, steamIDUser: t.CSteamID) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamParties_OnReservationCompleted:\n\t- ulBeacon = {any}\n\t- steamIDUser = {any}\n\n", .{ ulBeacon, steamIDUser });
            return undefined;
        }
    }).noImpl;
    pub const CancelReservation = t.getImplFn("ISteamParties", "CancelReservation", fn(t.PartyBeaconID_t, t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(ulBeacon: t.PartyBeaconID_t, steamIDUser: t.CSteamID) callconv(.C) anyopaque {
...
pub const ISteamRemoteStorage = struct {
    ...
    pub const SetCloudEnabledForApp = t.getImplFn("ISteamRemoteStorage", "SetCloudEnabledForApp", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bEnabled: bool) callconv(.C) anyopaque {
...
pub const ISteamApps = struct {
    ...
    pub const InstallDLC = t.getImplFn("ISteamApps", "InstallDLC", fn(t.AppId_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nAppID: t.AppId_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamApps_InstallDLC:\n\t- nAppID = {any}\n\n", .{ nAppID });
            return undefined;
        }
    }).noImpl;
    pub const UninstallDLC = t.getImplFn("ISteamApps", "UninstallDLC", fn(t.AppId_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nAppID: t.AppId_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamApps_UninstallDLC:\n\t- nAppID = {any}\n\n", .{ nAppID });
            return undefined;
        }
    }).noImpl;
    pub const RequestAppProofOfPurchaseKey = t.getImplFn("ISteamApps", "RequestAppProofOfPurchaseKey", fn(t.AppId_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nAppID: t.AppId_t) callconv(.C) anyopaque {
    ...
    pub const RequestAllProofOfPurchaseKeys = t.getImplFn("ISteamApps", "RequestAllProofOfPurchaseKeys", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
...
pub const ISteamScreenshots = struct {
    ...
    pub const TriggerScreenshot = t.getImplFn("ISteamScreenshots", "TriggerScreenshot", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamScreenshots_TriggerScreenshot\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const HookScreenshots = t.getImplFn("ISteamScreenshots", "HookScreenshots", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bHook: bool) callconv(.C) anyopaque {
...
pub const ISteamMusic = struct {
    ...
    pub const Play = t.getImplFn("ISteamMusic", "Play", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMusic_Play\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const Pause = t.getImplFn("ISteamMusic", "Pause", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMusic_Pause\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const PlayPrevious = t.getImplFn("ISteamMusic", "PlayPrevious", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMusic_PlayPrevious\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const PlayNext = t.getImplFn("ISteamMusic", "PlayNext", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamMusic_PlayNext\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const SetVolume = t.getImplFn("ISteamMusic", "SetVolume", fn(f32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(flVolume: f32) callconv(.C) anyopaque {
...
pub const ISteamInput = struct {
    ...
    pub const RunFrame = t.getImplFn("ISteamInput", "RunFrame", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bReservedValue: bool) callconv(.C) anyopaque {
    ...
    pub const EnableDeviceCallbacks = t.getImplFn("ISteamInput", "EnableDeviceCallbacks", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamInput_EnableDeviceCallbacks\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const EnableActionEventCallbacks = t.getImplFn("ISteamInput", "EnableActionEventCallbacks", fn(t.SteamInputActionEventCallbackPointer) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pCallback: t.SteamInputActionEventCallbackPointer) callconv(.C) anyopaque {
    ...
    pub const ActivateActionSet = t.getImplFn("ISteamInput", "ActivateActionSet", fn(t.InputHandle_t, t.InputActionSetHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, actionSetHandle: t.InputActionSetHandle_t) callconv(.C) anyopaque {
    ...
    pub const ActivateActionSetLayer = t.getImplFn("ISteamInput", "ActivateActionSetLayer", fn(t.InputHandle_t, t.InputActionSetHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, actionSetLayerHandle: t.InputActionSetHandle_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamInput_ActivateActionSetLayer:\n\t- inputHandle = {any}\n\t- actionSetLayerHandle = {any}\n\n", .{ inputHandle, actionSetLayerHandle });
            return undefined;
        }
    }).noImpl;
    pub const DeactivateActionSetLayer = t.getImplFn("ISteamInput", "DeactivateActionSetLayer", fn(t.InputHandle_t, t.InputActionSetHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, actionSetLayerHandle: t.InputActionSetHandle_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamInput_DeactivateActionSetLayer:\n\t- inputHandle = {any}\n\t- actionSetLayerHandle = {any}\n\n", .{ inputHandle, actionSetLayerHandle });
            return undefined;
        }
    }).noImpl;
    pub const DeactivateAllActionSetLayers = t.getImplFn("ISteamInput", "DeactivateAllActionSetLayers", fn(t.InputHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t) callconv(.C) anyopaque {
    ...
    pub const StopAnalogActionMomentum = t.getImplFn("ISteamInput", "StopAnalogActionMomentum", fn(t.InputHandle_t, t.InputAnalogActionHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, eAction: t.InputAnalogActionHandle_t) callconv(.C) anyopaque {
    ...
    pub const TriggerVibration = t.getImplFn("ISteamInput", "TriggerVibration", fn(t.InputHandle_t, u16, u16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, usLeftSpeed: u16, usRightSpeed: u16) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamInput_TriggerVibration:\n\t- inputHandle = {any}\n\t- usLeftSpeed = {any}\n\t- usRightSpeed = {any}\n\n", .{ inputHandle, usLeftSpeed, usRightSpeed });
            return undefined;
        }
    }).noImpl;
    pub const TriggerVibrationExtended = t.getImplFn("ISteamInput", "TriggerVibrationExtended", fn(t.InputHandle_t, u16, u16, u16, u16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, usLeftSpeed: u16, usRightSpeed: u16, usLeftTriggerSpeed: u16, usRightTriggerSpeed: u16) callconv(.C) anyopaque {
    ...
    pub const TriggerSimpleHapticEvent = t.getImplFn("ISteamInput", "TriggerSimpleHapticEvent", fn(t.InputHandle_t, t.EControllerHapticLocation, t.uint8, u8, t.uint8, u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, eHapticLocation: t.EControllerHapticLocation, nIntensity: t.uint8, nGainDB: u8, nOtherIntensity: t.uint8, nOtherGainDB: u8) callconv(.C) anyopaque {
    ...
    pub const SetLEDColor = t.getImplFn("ISteamInput", "SetLEDColor", fn(t.InputHandle_t, t.uint8, t.uint8, t.uint8, u32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, nColorR: t.uint8, nColorG: t.uint8, nColorB: t.uint8, nFlags: u32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamInput_SetLEDColor:\n\t- inputHandle = {any}\n\t- nColorR = {any}\n\t- nColorG = {any}\n\t- nColorB = {any}\n\t- nFlags = {any}\n\n", .{ inputHandle, nColorR, nColorG, nColorB, nFlags });
            return undefined;
        }
    }).noImpl;
    pub const Legacy_TriggerHapticPulse = t.getImplFn("ISteamInput", "Legacy_TriggerHapticPulse", fn(t.InputHandle_t, t.ESteamControllerPad, u16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, eTargetPad: t.ESteamControllerPad, usDurationMicroSec: u16) callconv(.C) anyopaque {
    ...
    pub const Legacy_TriggerRepeatedHapticPulse = t.getImplFn("ISteamInput", "Legacy_TriggerRepeatedHapticPulse", fn(t.InputHandle_t, t.ESteamControllerPad, u16, u16, u16, u32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(inputHandle: t.InputHandle_t, eTargetPad: t.ESteamControllerPad, usDurationMicroSec: u16, usOffMicroSec: u16, unRepeat: u16, nFlags: u32) callconv(.C) anyopaque {
...
pub const ISteamController = struct {
    ...
    pub const RunFrame = t.getImplFn("ISteamController", "RunFrame", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const ActivateActionSet = t.getImplFn("ISteamController", "ActivateActionSet", fn(t.ControllerHandle_t, t.ControllerActionSetHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, actionSetHandle: t.ControllerActionSetHandle_t) callconv(.C) anyopaque {
    ...
    pub const ActivateActionSetLayer = t.getImplFn("ISteamController", "ActivateActionSetLayer", fn(t.ControllerHandle_t, t.ControllerActionSetHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, actionSetLayerHandle: t.ControllerActionSetHandle_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamController_ActivateActionSetLayer:\n\t- controllerHandle = {any}\n\t- actionSetLayerHandle = {any}\n\n", .{ controllerHandle, actionSetLayerHandle });
            return undefined;
        }
    }).noImpl;
    pub const DeactivateActionSetLayer = t.getImplFn("ISteamController", "DeactivateActionSetLayer", fn(t.ControllerHandle_t, t.ControllerActionSetHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, actionSetLayerHandle: t.ControllerActionSetHandle_t) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamController_DeactivateActionSetLayer:\n\t- controllerHandle = {any}\n\t- actionSetLayerHandle = {any}\n\n", .{ controllerHandle, actionSetLayerHandle });
            return undefined;
        }
    }).noImpl;
    pub const DeactivateAllActionSetLayers = t.getImplFn("ISteamController", "DeactivateAllActionSetLayers", fn(t.ControllerHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t) callconv(.C) anyopaque {
    ...
    pub const StopAnalogActionMomentum = t.getImplFn("ISteamController", "StopAnalogActionMomentum", fn(t.ControllerHandle_t, t.ControllerAnalogActionHandle_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, eAction: t.ControllerAnalogActionHandle_t) callconv(.C) anyopaque {
    ...
    pub const TriggerHapticPulse = t.getImplFn("ISteamController", "TriggerHapticPulse", fn(t.ControllerHandle_t, t.ESteamControllerPad, u16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, eTargetPad: t.ESteamControllerPad, usDurationMicroSec: u16) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamController_TriggerHapticPulse:\n\t- controllerHandle = {any}\n\t- eTargetPad = {any}\n\t- usDurationMicroSec = {any}\n\n", .{ controllerHandle, eTargetPad, usDurationMicroSec });
            return undefined;
        }
    }).noImpl;
    pub const TriggerRepeatedHapticPulse = t.getImplFn("ISteamController", "TriggerRepeatedHapticPulse", fn(t.ControllerHandle_t, t.ESteamControllerPad, u16, u16, u16, u32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, eTargetPad: t.ESteamControllerPad, usDurationMicroSec: u16, usOffMicroSec: u16, unRepeat: u16, nFlags: u32) callconv(.C) anyopaque {
    ...
    pub const TriggerVibration = t.getImplFn("ISteamController", "TriggerVibration", fn(t.ControllerHandle_t, u16, u16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, usLeftSpeed: u16, usRightSpeed: u16) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamController_TriggerVibration:\n\t- controllerHandle = {any}\n\t- usLeftSpeed = {any}\n\t- usRightSpeed = {any}\n\n", .{ controllerHandle, usLeftSpeed, usRightSpeed });
            return undefined;
        }
    }).noImpl;
    pub const SetLEDColor = t.getImplFn("ISteamController", "SetLEDColor", fn(t.ControllerHandle_t, t.uint8, t.uint8, t.uint8, u32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(controllerHandle: t.ControllerHandle_t, nColorR: t.uint8, nColorG: t.uint8, nColorB: t.uint8, nFlags: u32) callconv(.C) anyopaque {
...
pub const ISteamUGC = struct {
    ...
    pub const SuspendDownloads = t.getImplFn("ISteamUGC", "SuspendDownloads", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bSuspend: bool) callconv(.C) anyopaque {
...
pub const ISteamHTMLSurface = struct {
    ...
    pub const RemoveBrowser = t.getImplFn("ISteamHTMLSurface", "RemoveBrowser", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_RemoveBrowser:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const LoadURL = t.getImplFn("ISteamHTMLSurface", "LoadURL", fn(t.HHTMLBrowser, [*c]const u8, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, pchURL: [*c]const u8, pchPostData: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_LoadURL:\n\t- unBrowserHandle = {any}\n\t- pchURL = {any}\n\t- pchPostData = {any}\n\n", .{ unBrowserHandle, pchURL, pchPostData });
            return undefined;
        }
    }).noImpl;
    pub const SetSize = t.getImplFn("ISteamHTMLSurface", "SetSize", fn(t.HHTMLBrowser, t.uint32, t.uint32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, unWidth: t.uint32, unHeight: t.uint32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetSize:\n\t- unBrowserHandle = {any}\n\t- unWidth = {any}\n\t- unHeight = {any}\n\n", .{ unBrowserHandle, unWidth, unHeight });
            return undefined;
        }
    }).noImpl;
    pub const StopLoad = t.getImplFn("ISteamHTMLSurface", "StopLoad", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_StopLoad:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const Reload = t.getImplFn("ISteamHTMLSurface", "Reload", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_Reload:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const GoBack = t.getImplFn("ISteamHTMLSurface", "GoBack", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_GoBack:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const GoForward = t.getImplFn("ISteamHTMLSurface", "GoForward", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_GoForward:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const AddHeader = t.getImplFn("ISteamHTMLSurface", "AddHeader", fn(t.HHTMLBrowser, [*c]const u8, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, pchKey: [*c]const u8, pchValue: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_AddHeader:\n\t- unBrowserHandle = {any}\n\t- pchKey = {any}\n\t- pchValue = {any}\n\n", .{ unBrowserHandle, pchKey, pchValue });
            return undefined;
        }
    }).noImpl;
    pub const ExecuteJavascript = t.getImplFn("ISteamHTMLSurface", "ExecuteJavascript", fn(t.HHTMLBrowser, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, pchScript: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_ExecuteJavascript:\n\t- unBrowserHandle = {any}\n\t- pchScript = {any}\n\n", .{ unBrowserHandle, pchScript });
            return undefined;
        }
    }).noImpl;
    pub const MouseUp = t.getImplFn("ISteamHTMLSurface", "MouseUp", fn(t.HHTMLBrowser, t.ISteamHTMLSurface.EHTMLMouseButton) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, eMouseButton: t.ISteamHTMLSurface.EHTMLMouseButton) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_MouseUp:\n\t- unBrowserHandle = {any}\n\t- eMouseButton = {any}\n\n", .{ unBrowserHandle, eMouseButton });
            return undefined;
        }
    }).noImpl;
    pub const MouseDown = t.getImplFn("ISteamHTMLSurface", "MouseDown", fn(t.HHTMLBrowser, t.ISteamHTMLSurface.EHTMLMouseButton) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, eMouseButton: t.ISteamHTMLSurface.EHTMLMouseButton) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_MouseDown:\n\t- unBrowserHandle = {any}\n\t- eMouseButton = {any}\n\n", .{ unBrowserHandle, eMouseButton });
            return undefined;
        }
    }).noImpl;
    pub const MouseDoubleClick = t.getImplFn("ISteamHTMLSurface", "MouseDoubleClick", fn(t.HHTMLBrowser, t.ISteamHTMLSurface.EHTMLMouseButton) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, eMouseButton: t.ISteamHTMLSurface.EHTMLMouseButton) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_MouseDoubleClick:\n\t- unBrowserHandle = {any}\n\t- eMouseButton = {any}\n\n", .{ unBrowserHandle, eMouseButton });
            return undefined;
        }
    }).noImpl;
    pub const MouseMove = t.getImplFn("ISteamHTMLSurface", "MouseMove", fn(t.HHTMLBrowser, i32, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, x: i32, y: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_MouseMove:\n\t- unBrowserHandle = {any}\n\t- x = {any}\n\t- y = {any}\n\n", .{ unBrowserHandle, x, y });
            return undefined;
        }
    }).noImpl;
    pub const MouseWheel = t.getImplFn("ISteamHTMLSurface", "MouseWheel", fn(t.HHTMLBrowser, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, nDelta: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_MouseWheel:\n\t- unBrowserHandle = {any}\n\t- nDelta = {any}\n\n", .{ unBrowserHandle, nDelta });
            return undefined;
        }
    }).noImpl;
    pub const KeyDown = t.getImplFn("ISteamHTMLSurface", "KeyDown", fn(t.HHTMLBrowser, t.uint32, t.ISteamHTMLSurface.EHTMLKeyModifiers, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, nNativeKeyCode: t.uint32, eHTMLKeyModifiers: t.ISteamHTMLSurface.EHTMLKeyModifiers, bIsSystemKey: bool) callconv(.C) anyopaque {
    ...
    pub const KeyUp = t.getImplFn("ISteamHTMLSurface", "KeyUp", fn(t.HHTMLBrowser, t.uint32, t.ISteamHTMLSurface.EHTMLKeyModifiers) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, nNativeKeyCode: t.uint32, eHTMLKeyModifiers: t.ISteamHTMLSurface.EHTMLKeyModifiers) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_KeyUp:\n\t- unBrowserHandle = {any}\n\t- nNativeKeyCode = {any}\n\t- eHTMLKeyModifiers = {any}\n\n", .{ unBrowserHandle, nNativeKeyCode, eHTMLKeyModifiers });
            return undefined;
        }
    }).noImpl;
    pub const KeyChar = t.getImplFn("ISteamHTMLSurface", "KeyChar", fn(t.HHTMLBrowser, t.uint32, t.ISteamHTMLSurface.EHTMLKeyModifiers) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, cUnicodeChar: t.uint32, eHTMLKeyModifiers: t.ISteamHTMLSurface.EHTMLKeyModifiers) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_KeyChar:\n\t- unBrowserHandle = {any}\n\t- cUnicodeChar = {any}\n\t- eHTMLKeyModifiers = {any}\n\n", .{ unBrowserHandle, cUnicodeChar, eHTMLKeyModifiers });
            return undefined;
        }
    }).noImpl;
    pub const SetHorizontalScroll = t.getImplFn("ISteamHTMLSurface", "SetHorizontalScroll", fn(t.HHTMLBrowser, t.uint32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, nAbsolutePixelScroll: t.uint32) callconv(.C) anyopaque {
    ...
    pub const SetVerticalScroll = t.getImplFn("ISteamHTMLSurface", "SetVerticalScroll", fn(t.HHTMLBrowser, t.uint32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, nAbsolutePixelScroll: t.uint32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetVerticalScroll:\n\t- unBrowserHandle = {any}\n\t- nAbsolutePixelScroll = {any}\n\n", .{ unBrowserHandle, nAbsolutePixelScroll });
            return undefined;
        }
    }).noImpl;
    pub const SetKeyFocus = t.getImplFn("ISteamHTMLSurface", "SetKeyFocus", fn(t.HHTMLBrowser, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, bHasKeyFocus: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetKeyFocus:\n\t- unBrowserHandle = {any}\n\t- bHasKeyFocus = {any}\n\n", .{ unBrowserHandle, bHasKeyFocus });
            return undefined;
        }
    }).noImpl;
    pub const ViewSource = t.getImplFn("ISteamHTMLSurface", "ViewSource", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_ViewSource:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const CopyToClipboard = t.getImplFn("ISteamHTMLSurface", "CopyToClipboard", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_CopyToClipboard:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const PasteFromClipboard = t.getImplFn("ISteamHTMLSurface", "PasteFromClipboard", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_PasteFromClipboard:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const Find = t.getImplFn("ISteamHTMLSurface", "Find", fn(t.HHTMLBrowser, [*c]const u8, bool, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, pchSearchStr: [*c]const u8, bCurrentlyInFind: bool, bReverse: bool) callconv(.C) anyopaque {
    ...
    pub const StopFind = t.getImplFn("ISteamHTMLSurface", "StopFind", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_StopFind:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const GetLinkAtPosition = t.getImplFn("ISteamHTMLSurface", "GetLinkAtPosition", fn(t.HHTMLBrowser, i32, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, x: i32, y: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_GetLinkAtPosition:\n\t- unBrowserHandle = {any}\n\t- x = {any}\n\t- y = {any}\n\n", .{ unBrowserHandle, x, y });
            return undefined;
        }
    }).noImpl;
    pub const SetCookie = t.getImplFn("ISteamHTMLSurface", "SetCookie", fn([*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, t.RTime32, bool, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchHostname: [*c]const u8, pchKey: [*c]const u8, pchValue: [*c]const u8, pchPath: [*c]const u8, nExpires: t.RTime32, bSecure: bool, bHTTPOnly: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetCookie:\n\t- pchHostname = {any}\n\t- pchKey = {any}\n\t- pchValue = {any}\n\t- pchPath = {any}\n\t- nExpires = {any}\n\t- bSecure = {any}\n\t- bHTTPOnly = {any}\n\n", .{ pchHostname, pchKey, pchValue, pchPath, nExpires, bSecure, bHTTPOnly });
            return undefined;
        }
    }).noImpl;
    pub const SetPageScaleFactor = t.getImplFn("ISteamHTMLSurface", "SetPageScaleFactor", fn(t.HHTMLBrowser, f32, i32, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, flZoom: f32, nPointX: i32, nPointY: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetPageScaleFactor:\n\t- unBrowserHandle = {any}\n\t- flZoom = {any}\n\t- nPointX = {any}\n\t- nPointY = {any}\n\n", .{ unBrowserHandle, flZoom, nPointX, nPointY });
            return undefined;
        }
    }).noImpl;
    pub const SetBackgroundMode = t.getImplFn("ISteamHTMLSurface", "SetBackgroundMode", fn(t.HHTMLBrowser, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, bBackgroundMode: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetBackgroundMode:\n\t- unBrowserHandle = {any}\n\t- bBackgroundMode = {any}\n\n", .{ unBrowserHandle, bBackgroundMode });
            return undefined;
        }
    }).noImpl;
    pub const SetDPIScalingFactor = t.getImplFn("ISteamHTMLSurface", "SetDPIScalingFactor", fn(t.HHTMLBrowser, f32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, flDPIScaling: f32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_SetDPIScalingFactor:\n\t- unBrowserHandle = {any}\n\t- flDPIScaling = {any}\n\n", .{ unBrowserHandle, flDPIScaling });
            return undefined;
        }
    }).noImpl;
    pub const OpenDeveloperTools = t.getImplFn("ISteamHTMLSurface", "OpenDeveloperTools", fn(t.HHTMLBrowser) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_OpenDeveloperTools:\n\t- unBrowserHandle = {any}\n\n", .{ unBrowserHandle });
            return undefined;
        }
    }).noImpl;
    pub const AllowStartRequest = t.getImplFn("ISteamHTMLSurface", "AllowStartRequest", fn(t.HHTMLBrowser, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, bAllowed: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_AllowStartRequest:\n\t- unBrowserHandle = {any}\n\t- bAllowed = {any}\n\n", .{ unBrowserHandle, bAllowed });
            return undefined;
        }
    }).noImpl;
    pub const JSDialogResponse = t.getImplFn("ISteamHTMLSurface", "JSDialogResponse", fn(t.HHTMLBrowser, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, bResult: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamHTMLSurface_JSDialogResponse:\n\t- unBrowserHandle = {any}\n\t- bResult = {any}\n\n", .{ unBrowserHandle, bResult });
            return undefined;
        }
    }).noImpl;
    pub const FileLoadDialogResponse = t.getImplFn("ISteamHTMLSurface", "FileLoadDialogResponse", fn(t.HHTMLBrowser, [*c][*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unBrowserHandle: t.HHTMLBrowser, pchSelectedFiles: [*c][*c]const u8) callconv(.C) anyopaque {
...
pub const ISteamInventory = struct {
    ...
    pub const DestroyResult = t.getImplFn("ISteamInventory", "DestroyResult", fn(t.SteamInventoryResult_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(resultHandle: t.SteamInventoryResult_t) callconv(.C) anyopaque {
    ...
    pub const SendItemDropHeartbeat = t.getImplFn("ISteamInventory", "SendItemDropHeartbeat", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
...
pub const ISteamVideo = struct {
    ...
    pub const GetVideoURL = t.getImplFn("ISteamVideo", "GetVideoURL", fn(t.AppId_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unVideoAppID: t.AppId_t) callconv(.C) anyopaque {
    ...
    pub const GetOPFSettings = t.getImplFn("ISteamVideo", "GetOPFSettings", fn(t.AppId_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unVideoAppID: t.AppId_t) callconv(.C) anyopaque {
...
pub const ISteamNetworkingSockets = struct {
    ...
    pub const SetConnectionName = t.getImplFn("ISteamNetworkingSockets", "SetConnectionName", fn(t.HSteamNetConnection, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hPeer: t.HSteamNetConnection, pszName: [*c]const u8) callconv(.C) anyopaque {
    ...
    pub const SendMessages = t.getImplFn("ISteamNetworkingSockets", "SendMessages", fn(i32, [*c]const [*c]t.SteamNetworkingMessage_t, [*c]i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(nMessages: i32, pMessages: [*c]const [*c]t.SteamNetworkingMessage_t, pOutMessageNumberOrResult: [*c]i32) callconv(.C) anyopaque {
    ...
    pub const ResetIdentity = t.getImplFn("ISteamNetworkingSockets", "ResetIdentity", fn([*c]const t.SteamNetworkingIdentity) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pIdentity: [*c]const t.SteamNetworkingIdentity) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamNetworkingSockets_ResetIdentity:\n\t- pIdentity = {any}\n\n", .{ pIdentity });
            return undefined;
        }
    }).noImpl;
    pub const RunCallbacks = t.getImplFn("ISteamNetworkingSockets", "RunCallbacks", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const GetFakeIP = t.getImplFn("ISteamNetworkingSockets", "GetFakeIP", fn(i32, [*c]t.SteamNetworkingFakeIPResult_t) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(idxFirstPort: i32, pInfo: [*c]t.SteamNetworkingFakeIPResult_t) callconv(.C) anyopaque {
...
pub const ISteamNetworkingUtils = struct {
    ...
    pub const InitRelayNetworkAccess = t.getImplFn("ISteamNetworkingUtils", "InitRelayNetworkAccess", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const ConvertPingLocationToString = t.getImplFn("ISteamNetworkingUtils", "ConvertPingLocationToString", fn([*c]const t.SteamNetworkPingLocation_t, [*c]u8, i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(location: [*c]const t.SteamNetworkPingLocation_t, pszBuf: [*c]u8, cchBufSize: i32) callconv(.C) anyopaque {
    ...
    pub const SetDebugOutputFunction = t.getImplFn("ISteamNetworkingUtils", "SetDebugOutputFunction", fn(t.ESteamNetworkingSocketsDebugOutputType, t.FSteamNetworkingSocketsDebugOutput) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(eDetailLevel: t.ESteamNetworkingSocketsDebugOutputType, pfnFunc: t.FSteamNetworkingSocketsDebugOutput) callconv(.C) anyopaque {
    ...
    pub const SteamNetworkingIPAddr_ToString = t.getImplFn("ISteamNetworkingUtils", "SteamNetworkingIPAddr_ToString", fn([*c]const t.SteamNetworkingIPAddr, [*c]u8, t.uint32, bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(addr: [*c]const t.SteamNetworkingIPAddr, buf: [*c]u8, cbBuf: t.uint32, bWithPort: bool) callconv(.C) anyopaque {
    ...
    pub const SteamNetworkingIdentity_ToString = t.getImplFn("ISteamNetworkingUtils", "SteamNetworkingIdentity_ToString", fn([*c]const t.SteamNetworkingIdentity, [*c]u8, t.uint32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(identity: [*c]const t.SteamNetworkingIdentity, buf: [*c]u8, cbBuf: t.uint32) callconv(.C) anyopaque {
...
pub const ISteamGameServer = struct {
    ...
    pub const SetProduct = t.getImplFn("ISteamGameServer", "SetProduct", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszProduct: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetProduct:\n\t- pszProduct = {any}\n\n", .{ pszProduct });
            return undefined;
        }
    }).noImpl;
    pub const SetGameDescription = t.getImplFn("ISteamGameServer", "SetGameDescription", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszGameDescription: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetGameDescription:\n\t- pszGameDescription = {any}\n\n", .{ pszGameDescription });
            return undefined;
        }
    }).noImpl;
    pub const SetModDir = t.getImplFn("ISteamGameServer", "SetModDir", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszModDir: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetModDir:\n\t- pszModDir = {any}\n\n", .{ pszModDir });
            return undefined;
        }
    }).noImpl;
    pub const SetDedicatedServer = t.getImplFn("ISteamGameServer", "SetDedicatedServer", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bDedicated: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetDedicatedServer:\n\t- bDedicated = {any}\n\n", .{ bDedicated });
            return undefined;
        }
    }).noImpl;
    pub const LogOn = t.getImplFn("ISteamGameServer", "LogOn", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszToken: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_LogOn:\n\t- pszToken = {any}\n\n", .{ pszToken });
            return undefined;
        }
    }).noImpl;
    pub const LogOnAnonymous = t.getImplFn("ISteamGameServer", "LogOnAnonymous", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_LogOnAnonymous\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const LogOff = t.getImplFn("ISteamGameServer", "LogOff", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const SetMaxPlayerCount = t.getImplFn("ISteamGameServer", "SetMaxPlayerCount", fn(i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(cPlayersMax: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetMaxPlayerCount:\n\t- cPlayersMax = {any}\n\n", .{ cPlayersMax });
            return undefined;
        }
    }).noImpl;
    pub const SetBotPlayerCount = t.getImplFn("ISteamGameServer", "SetBotPlayerCount", fn(i32) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(cBotplayers: i32) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetBotPlayerCount:\n\t- cBotplayers = {any}\n\n", .{ cBotplayers });
            return undefined;
        }
    }).noImpl;
    pub const SetServerName = t.getImplFn("ISteamGameServer", "SetServerName", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszServerName: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetServerName:\n\t- pszServerName = {any}\n\n", .{ pszServerName });
            return undefined;
        }
    }).noImpl;
    pub const SetMapName = t.getImplFn("ISteamGameServer", "SetMapName", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszMapName: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetMapName:\n\t- pszMapName = {any}\n\n", .{ pszMapName });
            return undefined;
        }
    }).noImpl;
    pub const SetPasswordProtected = t.getImplFn("ISteamGameServer", "SetPasswordProtected", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bPasswordProtected: bool) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetPasswordProtected:\n\t- bPasswordProtected = {any}\n\n", .{ bPasswordProtected });
            return undefined;
        }
    }).noImpl;
    pub const SetSpectatorPort = t.getImplFn("ISteamGameServer", "SetSpectatorPort", fn(t.uint16) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(unSpectatorPort: t.uint16) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetSpectatorPort:\n\t- unSpectatorPort = {any}\n\n", .{ unSpectatorPort });
            return undefined;
        }
    }).noImpl;
    pub const SetSpectatorServerName = t.getImplFn("ISteamGameServer", "SetSpectatorServerName", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszSpectatorServerName: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetSpectatorServerName:\n\t- pszSpectatorServerName = {any}\n\n", .{ pszSpectatorServerName });
            return undefined;
        }
    }).noImpl;
    pub const ClearAllKeyValues = t.getImplFn("ISteamGameServer", "ClearAllKeyValues", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_ClearAllKeyValues\n\n", .{  });
            return undefined;
        }
    }).noImpl;
    pub const SetKeyValue = t.getImplFn("ISteamGameServer", "SetKeyValue", fn([*c]const u8, [*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pKey: [*c]const u8, pValue: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetKeyValue:\n\t- pKey = {any}\n\t- pValue = {any}\n\n", .{ pKey, pValue });
            return undefined;
        }
    }).noImpl;
    pub const SetGameTags = t.getImplFn("ISteamGameServer", "SetGameTags", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchGameTags: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetGameTags:\n\t- pchGameTags = {any}\n\n", .{ pchGameTags });
            return undefined;
        }
    }).noImpl;
    pub const SetGameData = t.getImplFn("ISteamGameServer", "SetGameData", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pchGameData: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetGameData:\n\t- pchGameData = {any}\n\n", .{ pchGameData });
            return undefined;
        }
    }).noImpl;
    pub const SetRegion = t.getImplFn("ISteamGameServer", "SetRegion", fn([*c]const u8) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(pszRegion: [*c]const u8) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_SetRegion:\n\t- pszRegion = {any}\n\n", .{ pszRegion });
            return undefined;
        }
    }).noImpl;
    pub const SetAdvertiseServerActive = t.getImplFn("ISteamGameServer", "SetAdvertiseServerActive", fn(bool) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(bActive: bool) callconv(.C) anyopaque {
    ...
    pub const EndAuthSession = t.getImplFn("ISteamGameServer", "EndAuthSession", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamID: t.CSteamID) callconv(.C) anyopaque {
            p("NOT IMPLEMENTED SteamAPI_ISteamGameServer_EndAuthSession:\n\t- steamID = {any}\n\n", .{ steamID });
            return undefined;
        }
    }).noImpl;
    pub const CancelAuthTicket = t.getImplFn("ISteamGameServer", "CancelAuthTicket", fn(t.HAuthTicket) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(hAuthTicket: t.HAuthTicket) callconv(.C) anyopaque {
    ...
    pub const GetGameplayStats = t.getImplFn("ISteamGameServer", "GetGameplayStats", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const SendUserDisconnect_DEPRECATED = t.getImplFn("ISteamGameServer", "SendUserDisconnect_DEPRECATED", fn(t.CSteamID) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(steamIDUser: t.CSteamID) callconv(.C) anyopaque {
...
pub const ISteamNetworkingFakeUDPPort = struct {
    pub const DestroyFakeUDPPort = t.getImplFn("ISteamNetworkingFakeUDPPort", "DestroyFakeUDPPort", fn() callconv(.C) anyopaque) orelse (struct {
        fn noImpl() callconv(.C) anyopaque {
    ...
    pub const ScheduleCleanup = t.getImplFn("ISteamNetworkingFakeUDPPort", "ScheduleCleanup", fn([*c]const t.SteamNetworkingIPAddr) callconv(.C) anyopaque) orelse (struct {
        fn noImpl(remoteAddress: [*c]const t.SteamNetworkingIPAddr) callconv(.C) anyopaque {
